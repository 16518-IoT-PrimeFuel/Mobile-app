          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 10),
                _driverInput('CORREO', _email, Icons.email_outlined),
                if (duplicate) ...[
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(
                'Licencia · ${driver.licenseNumber} · ${driver.phoneNumber}',
...
String _driverStatusLabel(String status) => switch (status.toUpperCase()) {
